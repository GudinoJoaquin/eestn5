  ...
  return (
    <header className="text-white text-center">
      <div className="mx-auto max-w-xl pt-10">
        <h1 className={`font-bold text-3xl md:text-5xl lg:text-6xl animate-fade-in-down`}>
          <span className="text-4xl md:text-6xl lg:text-7xl">E. E. S. T. N°5</span>
        </h1>
        <h2 className={`font-semibold text-xl md:text-2xl lg:text-3xl animate-pulse-fade-in`}>
          Amancio Williams
        </h2>
