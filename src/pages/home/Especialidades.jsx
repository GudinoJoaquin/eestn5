  ...
  return (
    <>
      ...
      <main className="mb-[50px]">
        ...
        <hr className="border-1 border-red-600 mx-auto my-[30px]" style={{ width: '50vw' }} />
          ...
          <div className="mx-4 md:mx-[220px]">
            ...
            <ol className="text-sm md:text-lg ml-4 mt-4 list-disc">
              <li style={{ marginBottom: '8px' }}>
                Facilitar la operatoria del usuario, ayudando a organizar sus archivos y dando apoyo para resolver problemas que habitualmente se le presentan y que, por falta de tiempo o conocimientos, están fuera de su alcance.
              </li>
              <li style={{ marginBottom: '8px' }}>
                Mantener la integridad de los datos locales del usuario, protegiéndolos mediante el resguardo preventivo de los mismos, ejecutar acciones anti-virus, incluyendo reparaciones de archivos afectados.
              </li>
              <li style={{ marginBottom: '8px' }}>
              ...
              <li style={{ marginBottom: '8px' }}>
                Optimizar el ambiente informático de trabajo del usuario, desarrollar programas, o adaptar y complementar sus funcionalidades.
              </li>
              <li style={{ marginBottom: '8px' }}>
        ...
        {visibleSection === "electronica" && (
          ...
          <div className="mx-4 md:mx-[220px]">
            ...
            <p className="text-sm md:text-lg italic mt-4">
              El Técnico en Electrónica está capacitado, de acuerdo a las actividades que se desarrollan en el perfil profesional, para montar e instalar, operar y mantener componentes, productos, equipos e instalaciones de electrónica analógica y/o digital; realizar proyectos, diseños y desarrollos de tecnología estándar; comercializar, seleccionar y asesorar en componentes, productos, equipos e instalaciones electrónicas; y participar y/o generar emprendimientos en electrónica.
            </p>
            <p className="text-sm md:text-lg font-bold mt-4">
              Áreas de competencia:
            </p>
            <ol className="text-sm md:text-lg list-disc ml-4 mt-4">
              <li style={{ marginBottom: '8px' }}>Proyectar componentes y productos electrónicos.</li>
              <li style={{ marginBottom: '8px' }}>Montar e instalar componentes, productos y equipos electrónicos.</li>
              <li style={{ marginBottom: '8px' }}>Operar y mantener componentes, productos y equipos electrónicos.</li>
              <li style={{ marginBottom: '8px' }}>Comercializar, seleccionar y asesorar en componentes, productos, equipos e instalaciones electrónicas.</li>
              <li style={{ marginBottom: '8px' }}>Generar y/o participar de emprendimientos.</li>
            </ol>
          </div>
        </section>
        ...
        {visibleSection === "construcciones" && (
          ...
          <div className="mx-4 md:mx-[220px]">
            ...
            <p className="text-sm md:text-lg italic mt-4">
              El Maestro Mayor de Obra estará capacitado, de acuerdo a las actividades que se desarrollan en el Perfil Profesional, para:
            </p>
            <p className="text-sm md:text-lg font-bold mt-4">
              Áreas de competencia:
            </p>
            <ol className="text-sm md:text-lg list-disc ml-4 mt-4">
              <li style={{ marginBottom: '8px' }}>Analizar las necesidades de un cliente y elaborar el programa de necesidades.</li>
              <li style={{ marginBottom: '8px' }}>Elaborar proyectos completos de construcciones edilicias, planificando, gestionando, administrando y controlando la ejecución del proceso constructivo.</li>
              <li style={{ marginBottom: '8px' }}>Dirigir la ejecución de los procesos constructivos.</li>
              <li style={{ marginBottom: '8px' }}>Ejecutar obras edilicias y conducir grupos de trabajo a cargo.</li>
              <li style={{ marginBottom: '8px' }}>Proyectar, dirigir, planificar, gestionar, administrar y controlar instalaciones correspondientes a energía, comunicaciones, agua, desagües, confort y transporte.</li>
              <li style={{ marginBottom: '8px' }}>Prestar servicios de evaluación técnica a terceros.</li>
              <li style={{ marginBottom: '8px' }}>Asesorar técnicamente a terceros para la comercialización de productos y/o servicios.</li>
            </ol>
          </div>
        </section>
        )}
